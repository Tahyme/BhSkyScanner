...
class FlightForm extends React.Component<Props, State> {
    state = {
        origin: '',
        destination: '',
    ...
    handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const searchResults = await Flights(this.state);
        ...
        return (
            <div className='formulaire'>
                <form  onSubmit={this.handleSubmit}>
                    <label>
                        Départ:
                        <input type="text" name="origin" value={this.state.origin} onChange={this.handleChange} placeholder="votre départ de ..." />
                    </label>
                    <label>
                        Arrivé:
                        <input type="text" name="destination" value={this.state.destination} onChange={this.handleChange} placeholder="vers ..."/>
                    </label>
                    <label>
                        Date: <br/>
